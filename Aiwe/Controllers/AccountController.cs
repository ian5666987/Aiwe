...
namespace Aiwe.Controllers {
  public class AccountController : Controller {
    ...
    public async Task<ActionResult> Login(LoginViewModel model, string returnUrl) {
      ...
      //http://stackoverflow.com/questions/19536955/request-isauthenticated-is-always-false
      //IMPORTANT: add the form authentication in web server to make the request authentication is NOT always false
