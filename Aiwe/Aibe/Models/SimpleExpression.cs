...
namespace Aibe.Models {
  ...
  public partial class SimpleExpression : BaseInfo {
    ...
    public SimpleExpression(string desc, string middleSign = null) : this(desc, string.IsNullOrWhiteSpace(middleSign) ? null : new List<string> { middleSign }) { }

    public SimpleExpression(string desc, List<string> middleSigns = null) : base(desc) {
